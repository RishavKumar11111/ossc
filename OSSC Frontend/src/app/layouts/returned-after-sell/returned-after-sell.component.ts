...
@Component({
  selector: 'app-returned-after-sell',
  templateUrl: './returned-after-sell.component.html',
  styleUrls: ['./returned-after-sell.component.css']
})
export class ReturnedAfterSellComponent implements OnInit {
